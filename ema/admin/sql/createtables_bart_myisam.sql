...
CREATE TABLE IF NOT EXISTS `survey1_actions` (
  ...
  `primkey` varchar(50) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `haalsi_households` (
  `primkey` varchar(25) NOT NULL,
...
INSERT INTO `survey1_users` (`urid`, `status`, `name`, `username`, `password`, `usertype`, `sup`, `filter`, `regionfilter`, `testmode`, `communication`, `settings`, `access`, `lastdata`, `ts`) VALUES
(1, 1, 'Sysadmin', 'sysadmin', 0x42c0d69a1f1c3f8792a8c9d140da4021, 4, NULL, 1, 0, 0, 2, 0x613a313a7b733a31303a226e6176696e6272656164223b733a313a2231223b7d, NULL, NULL, '2014-04-12 00:20:49');
