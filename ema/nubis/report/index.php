...
<div class="tab-content">
    <div role="tabpanel" class="tab-pane active" id="newissue">';
        ...
        $returnStr .= '<button onclick="window.close();" type="cancel" class="btn btn-default" style="min-width:100px">' . Language::buttonCancel() . '</button>';
        $returnStr .= "</form>";
    ...
    function reportRes() {
        ...
        $returnStr .= '                </div>
                <div class="panel-body">';
        $returnStr .= '<div class="alert alert-success">' . Language::reportProblemConfirmation() . '</div>';
...
$page = getFromSessionParams('reportpage');
