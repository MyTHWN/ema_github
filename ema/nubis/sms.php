    ...
    function getPage() {   
        ...
        if ($this->user->isActive()){
            switch ($this->user->getUserType()) {
                case USER_INTERVIEWER: return $this->getInterviewerMain(); break;
                case USER_SUPERVISOR: return $this->getSupervisorMain(); break;
                case USER_TRANSLATOR: return $this->getTranslatorMain(); break;
                case USER_RESEARCHER: return $this->getResearcherMain(); break;
                case USER_SYSADMIN: return $this->getSysAdminMain(); break;
                case USER_NURSE: return $this->getNurseMain(); break;
                case USER_TESTER: return $this->getTesterMain(); break;
            }
        }
        else {
