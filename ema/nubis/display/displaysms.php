...
//        $headers[] = array('link' => setSessionParamsHref(array('page' => 'sysadmin.sms'), 'SMS'), 'label' => 'SMS');
    ...
    function showMetaDataUpdate($message = '') {
        ...
        /*
          ...
          $returnStr .= setSessionParamsPost(array('page' => 'sysadmin.sms.update.res'));

          $returnStr .= '<table>';
          $returnStr .= '<tr><td><label><input name="metadata" type="checkbox" value="1"> Update all meta data (SQL)' . '</label></td></tr>';
          $returnStr .= '<tr><td><label><input name="scripts" type="checkbox" value="1"> Update all scripts (php)' . '</label></td></tr>';
