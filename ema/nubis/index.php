...
//IS THE SESSION ID UNIQUE OVER TIME?? OTHERWISE MAKE IT UNIQUE
...
if (loadvar(POST_PARAM_SMS_AJAX) == SMS_AJAX_CALL) { //ajax call
...
//echo getFromSessionParams('page');
//print_r($_SESSION);
//echo generateRandomPrimkey(32);
