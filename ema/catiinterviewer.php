...
//        echo '<br/><br/><br/>-----' . getFromSessionParams('page') . ";;" . getFromSessionParams('primkey');
        if (getFromSessionParams('page') != null) {
            ...
            switch (getFromSessionParams('page')) {
                case 'catiinterviewer.answer': return $this->showPhoneAnswer(getFromSessionParams('primkey')); break;
                case 'catiinterviewer.startsurvey': return $this->showCatiStartSurvey(getFromSessionParams('primkey')); break;
                case 'catiinterviewer.noanswer.answeringmachine': return $this->showAnsweringMachine(getFromSessionParams('primkey')); break;
                case 'catiinterviewer.noanswer.answeringmachine.res': return $this->showAnsweringMachineRes(getFromSessionParams('primkey')); break;
                case 'catiinterviewer.noanswer.maxnumberrings': return $this->showMaxRings(getFromSessionParams('primkey')); break;
                case 'catiinterviewer.noanswer.disconnected': return $this->showDisconnected(getFromSessionParams('primkey')); break;
                case 'catiinterviewer.refusal': return $this->showRefusal(getFromSessionParams('primkey')); break;
                case 'catiinterviewer.barriers': return $this->showBarriers(getFromSessionParams('primkey')); break;
								case 'catiinterviewer.schedule': return $this->showSchedule(getFromSessionParams('primkey')); break;
								case 'catiinterviewer.schedule.res': return $this->showScheduleRes(getFromSessionParams('primkey')); break;
                case 'catiinterviewer.disconnect': return $this->showDisconnectDuringSurvey(getFromSessionParams('primkey')); break;


                case 'interviewer.calendar': return $this->showCalendar(); break;
